...
ZIMAGE_DIR="$KERNEL_DIR/arch/arm64/boot"
	...
	#export CROSS_COMPILE="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/aarch64-linux-gnu-"
	...
	#export CROSS_COMPILE_ARM32="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/arm-linux-gnueabi-"
	export CROSS_COMPILE_ARM32="ccache "$TOOLCHAINS_DIRECTORY"gcc-9.2-arm-none-eabi/bin/arm-none-eabi-"
	export LDLLD="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/ld.lld"
	#export LDLLD="ccache "$TOOLCHAINS_DIRECTORY"android_prebuilts_clang_host_linux-x86_clang-6443078/bin/ld.lld"
	export CC="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/clang"
	#export CC="ccache "$TOOLCHAINS_DIRECTORY"android_prebuilts_clang_host_linux-x86_clang-6443078/bin/clang"
	export AR="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/llvm-ar"
	export NM="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/llvm-nm"
	export OBJCOPY="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/llvm-objcopy"
	export OBJDUMP="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/llvm-objdump"
	export STRIP="ccache "$TOOLCHAINS_DIRECTORY"samsung-exynos9820-toolchain-proton/bin/llvm-strip"
